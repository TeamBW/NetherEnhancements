package com.teambw.ne.common.lib;

public class LibMisc {

    public static final String ID = "ne";
    public static final String NAME = "Nether Enhancements";
    public static final String VERISON = "1.7.10-15.13.4-R0.0";
